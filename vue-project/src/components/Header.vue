...
<template>
  <header class="header">
     <!-- Este checkbox está oculto, pero controla el menú desplegable. -->
    <!-- Lo movemos fuera del 'inner' para que 'dropdown-menu' sea su "hermano" (~) */ -->
    <input type="checkbox" id="toggle-filtros" class="header__toggle-filtros" />

    <!-- .header__inner alinea todos los elementos del header principal -->
    <div class="header__inner">
      <div class="header__left">
        <!-- Clase especial para anular el hover verde en el logo -->
      ...
      <nav class="header__nav">
        ...
        <!-- El 'label' activa el checkbox 'toggle-filtros' al hacer clic -->
      ...
      <div class="header__right">
        <!-- Clase especial para anular el hover verde en el perfil -->
        <RouterLink to="/profile" class="header-icon-link">
          <img src="/icono-perfil.png" alt="Perfil" class="header__profile-icon" />
        </RouterLink>
      </div>
    </div>
    ...
    <div class="dropdown-menu">
      <!-- .dropdown-menu__inner centra las 3 columnas -->
      <div class="dropdown-menu__inner">
        
        <!-- Columna 1 -->
        <div class="dropdown-menu__column">
          <h3 class="dropdown-menu__title">FAVORITOS</h3>
          <div class="dropdown-menu__links-wrapper">
            <!-- Cada enlace usa un query param (ej: ?filter=guardados) -->
        ...
        <div class="dropdown-menu__column">
          ...
          <div class="dropdown-menu__links-wrapper">
            <RouterLink to="/list?filter=salado" class="dropdown-menu__link">Salado</RouterLink>
            <RouterLink to="/list?filter=dulce" class="dropdown-menu__link">Dulce</RouterLink>
          </div>
        </div>
        ...
        <div class="dropdown-menu__column">
          ...
          <div class="dropdown-menu__links-wrapper">
            <RouterLink to="/list?filter=desayuno" class="dropdown-menu__link">Desayunos</RouterLink>
            <RouterLink to="/list?filter=comida" class="dropdown-menu__link">Comidas</RouterLink>
            <RouterLink to="/list?filter=cena" class="dropdown-menu__link">Cenas</RouterLink>
          </div>
        </div>
